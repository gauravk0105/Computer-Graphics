...
{   
  ...
  glColor3f(0.0f, 1.0f, 1.0f); 
  midPointAlgorithm(j+a11,a12,j+fl11,fl12);

  glColor3f(0.0f, 1.0f, 1.0f);
  midPointAlgorithm(j+a11,a12,j+bl11,bl12);

  glColor3f(1.0f, 0.0f, 1.0f);
  midPointAlgorithm(j+a11,a12,j+c1,c2);

  glColor3f(1.0f, 1.0f, 0.0f);
  midPointAlgorithm(j+b11,b12,j+fh11,fh12);

  glColor3f(1.0f, 1.0f, 0.0f);
  midPointAlgorithm(j+b11,b12,j+bh11,bh12);
